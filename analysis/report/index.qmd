...
subtitle: 'Browser-based access to a home machine from an iPhone, without SSH or open ports'
...
![A phone displaying a terminal window connected to a laptop over a private network, illustrating remote shell access from a mobile device.](media/images/hero.png){.img-fluid width=80%}
